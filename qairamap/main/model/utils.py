import qairamap.main.model.exceptions as exceptions
from qairamap.main.model.company import Company
...
def checkEmailIsFromCompany(email, company):
    if getEmailGroup(email) != company.email_group:
        raise exceptions.EmailNotFromCompanyError(company.name, email)
